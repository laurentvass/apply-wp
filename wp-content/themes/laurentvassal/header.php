...
<head>
	...
	<!-- favicon -->
	<link rel="shortcut icon" href="<?=get_stylesheet_directory_uri();?>/assets/images/favicon.png" type="image/png">
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?=get_stylesheet_directory_uri();?>/assets/images/apple-touch-icon-114x114-precomposed.png">
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?=get_stylesheet_directory_uri();?>/assets/images/apple-touch-icon-72x72-precomposed.png">
	<link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?=get_stylesheet_directory_uri();?>/assets/images/apple-touch-icon-57x57-precomposed.png">
